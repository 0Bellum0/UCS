...
public class Cinema implements Serializable {
	...
	public void listIngressos() {
		for(Ingresso ingresso : ingressos) {
			System.out.println("Comprador: " + ingresso.getComprador());
			System.out.println("Data: " + ingresso.getData());
			ingresso.getMeia();
			System.out.println("valor: " + ingresso.getPrecoFinal());
			System.out.println("Celular: " + ingresso.getCelular());
			ingresso.lugar();
			/*System.out.println(": " + ingresso.get);
			System.out.println(": " + ingresso.get);
			System.out.println(": " + ingresso.get);*/
		}
	}
